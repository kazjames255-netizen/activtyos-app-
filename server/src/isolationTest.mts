...
// Each creates a listing and a booking in their own tenant.
...
check("tenant A created a booking", bookA.status === 201, bookA);
...
check("parent books tenant A's listing", parBook.status === 201, parBook);
