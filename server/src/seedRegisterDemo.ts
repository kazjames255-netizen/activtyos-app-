...
const KIDS: Kid[] = [
  ...
  { first: "Noah", last: "Green", age: 9, dob: "2017-06-02", booker: "Dan Green", block: "am", flags: { send: "1", sendPlanName: "ASD support plan", likes: "Lego, football stickers", dislikes: "Being rushed between activities" }, att: { kind: "in", in: "08:45" } },
  { first: "Leo", last: "Brooks", age: 8, dob: "2018-01-20", booker: "Marco Brooks", block: "am", flags: { dietary: "Halal", allergies: "Dairy", likes: "Football — will play all day", dislikes: "Sitting still for long" }, att: { kind: "in", in: "08:52" } },
  { first: "Mia", last: "Patel", age: 6, dob: "2020-09-11", booker: "Raj Patel", block: "am", flags: { medical: "Asthma — blue inhaler kept with staff", likes: "Singing, dressing up", dislikes: "Getting her hands messy" }, att: { kind: "none" } },
  { first: "Sofia", last: "Rossi", age: 10, dob: "2016-05-30", booker: "Marco Rossi", block: "am", flags: { medical: "Type 1 diabetes", careNotes: "Individual healthcare plan on file", likes: "Reading in a quiet corner", dislikes: "Big noisy games" }, att: { kind: "absent" } },
  ...
  { first: "Isla", last: "Murphy", age: 10, dob: "2016-12-01", booker: "Ciara Murphy", block: "pm", flags: { medical: "Epilepsy — care plan with staff", likes: "Animals — knows every fact", dislikes: "Sudden loud noises" }, att: { kind: "absent" } },
