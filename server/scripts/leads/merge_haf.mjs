...
const db = admin.firestore(); const DIR = process.env.S + "/haf-la"; const DONE = process.env.S + "/haf-merged.json";
...
fs.writeFileSync(process.env.S + "/haf-councils.json", JSON.stringify(councils));
