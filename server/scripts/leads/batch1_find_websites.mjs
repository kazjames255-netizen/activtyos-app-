...
//   scripts/leads/out/batch1_websearch.rescan.out.jsonl, separate done-tracking); apply only ever writes a lead when THIS
...
const OUT = path.resolve(RESCAN ? "scripts/leads/out/batch1_websearch.rescan.out.jsonl" : "scripts/leads/out/batch1_websearch.out.jsonl");
