...
export const DIAGRAM_DATA: DiagramDef[] = [
  {
    ...
    parts: [
      ...
      p("mito", "mitochondrion", 110, 110, 2, "Where aerobic respiration releases energy.", ["mitochondria"], { x: 72, y: 88 }),
  ...
  },
  {
    ...
    parts: [
      ...
      p("chloroplast", "chloroplast", 110, 72, 2, "Green structure where photosynthesis takes place.", ["chloroplasts"], { x: 74, y: 72 }),
    ],
  },
  {
  ...
  },
  {
    ...
    parts: [
      ...
      p("stigma", "stigma", 200, 84, 2, "Sticky top of the female part that catches pollen.", ["stigmas"], { x: 236, y: 64 }),
      p("style", "style", 200, 120, 3, "Stalk joining the sticky top to the ovary.", ["styles"]),
      p("ovary", "ovary", 200, 166, 1, "Contains the ovules; later becomes the fruit.", ["ovaries"]),
    ],
  },
  {
  ...
  },
  {
    ...
    parts: [
      p("cuticle", "cuticle", 340, 44, 3, "Waxy waterproof coating that cuts down water loss.", ["waxy cuticle", "waxy layer"]),
  ...
  },
  {
    ...
    parts: [
      p("cell", "cell", 60, 146, 1, "Provides the push (potential difference) that drives current.", ["battery", "power supply"], { x: 105, y: 146 }),
      p("switch", "switch", 167.5, 51, 1, "Opens or closes the circuit to stop or start the current.", ["switches"]),
      p("bulb", "bulb", 324, 150, 1, "Transfers electrical energy as light.", ["lamp", "light bulb", "filament lamp"], { x: 295, y: 150 }),
      p("resistor", "resistor", 270, 60, 2, "Component that opposes the flow of current.", ["fixed resistor"]),
      p("ammeter", "ammeter", 200, 226, 2, "Measures current; connected in series.", ["ammeters"], { x: 200, y: 200 }),
      p("voltmeter", "voltmeter", 375, 137, 2, "Measures potential difference; connected in parallel across a component.", ["voltmeters"], { x: 385, y: 85 }),
