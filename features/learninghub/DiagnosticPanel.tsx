...
// Placement test — the same machinery as quizzes with type "diagnostic": one per
// subject, sat once, and the server records each topic's baseline from it.
export const meta: PanelMeta = { key: "diagnostic", label: "Placement test", icon: "🧭", status: "live", blurb: "A one-off test per subject that sets your starting level before quizzes count towards progress." };
