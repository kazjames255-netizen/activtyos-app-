...
export const PANEL_MODULES: { meta: PanelMeta; Panel: ComponentType<PanelProps> }[] = [
  Home, Live, Progress, Diagnostic, Quizzes, Homework, Flashcards,
];
...
export const TAB_ORDER: PanelMeta["key"][] = ["home", "live", "students", "dashboard", "diagnostic", "quizzes", "homework", "notes", "flashcards"];
