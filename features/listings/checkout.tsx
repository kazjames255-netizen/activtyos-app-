                        ...
                        return (
                          <div key={a.id} className="mb-2.5 last:mb-0">
                            ...
                            {kids.map((kid) => {
                              ...
                              return (
                                <div key={kid} className="mt-2">
                                  {/* Just the days. A parent choosing lunches is
                                      picking dates off a calendar, not reading a
                                      price list — the cost is on the line above
                                      and in the total. */}
                                    ...
                                    {x.dates.map((iso) => {
                                      ...
                                      return (
                                        <button key={iso} type="button"
                                          ...
                                          className={`flex min-w-[62px] flex-col items-center gap-0.5 border-2 px-2 py-2 ${tk.round}`}
                                          style={active
                                            ? { borderColor: tk.accent, background: tk.accent, color: tk.accentInk }
                                            : { borderColor: tk.line, color: tk.muted }}>
