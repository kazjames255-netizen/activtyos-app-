  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Card className="p-5">
        ...
        <SelRow label="Co-worker schedule visibility" desc="Who can see the team's “Who’s on this week” rota + who's clocked in. Same listing = staff see everyone rostered on a listing they work on; Leads & managers = only leads see it." value={value.coworkerVisibility} onChange={(v) => set("coworkerVisibility", v as SchedulingSettings["coworkerVisibility"])} opts={[["all", "All staff"], ["team", "Same listing only"], ["leads", "Leads & managers only"], ["none", "Hidden"]]} />
        <TogRow label="Staff can see the team's time-off" desc="Show the “colleagues off this week” calendar on a staff member's Time-off page (anonymous counts, not names). Off = they only see their own." value={value.staffSeeTeamAbsence} onChange={(v) => set("staffSeeTeamAbsence", v)} />
