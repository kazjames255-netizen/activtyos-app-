...
export const TOUR_STEPS: Record<string, LiveTourSteps> = {
  ...
  listings: {
    ...
    steps: [
      ...
      { find: "Make a great first impression", fill: [["Listing title", "Summer Holiday Multi-Sports Camp"]], line: "First, the photos and a clear title — watch, I'll name this one Summer Holiday Multi-Sports Camp. A big image makes a great first impression.", advance: "Next" },
      { find: "Where, who & how many", fill: [["Venue", "Riverside Sports Hall"], ["Age from", "5"], ["Age to", "12"]], pick: ["Holiday Multi-Activity Camps"], line: "Next, where and who — I'll set the venue to Riverside, the ages five to twelve, and tick the holiday-camp category.", advance: "Next" },
      { find: "How many can come", fill: [["capacity", "60"]], line: "Then how many can come — I'll cap this one at sixty, or you can leave it blank and cap each age band instead.", advance: "Next" },
      { find: "Describe your activity", fill: [["description", "A fun-packed week of multi-sports, games and team challenges — something for every child, with qualified coaches throughout."]], line: "Describe the activity so parents know exactly what their child will be doing.", advance: "Next" },
      { find: "Safety & inclusion", line: "Safety and inclusion — you tick the chips for your ratios, first aid, and the needs you can support.", advance: "Next" },
      { find: "When it runs", line: "Choose the dates and days it runs, and the calendar builds each session for you.", advance: "Next" },
      { find: "Tickets & pricing", line: "Add your tickets and prices — a full week, single days, or whatever pass you offer.", advance: "Next" },
      { find: "Automatic discounts", line: "Set automatic discounts if you like, then preview and publish — and it's live for parents to book." },
    ],
  },
