...
TOUR_CONFIGS.timesheets = {
  title: "Clock in/out & timesheets",
  introLine: "This is where your team's clock-ins turn into paid hours. You see who's on shift right now, review today's clocked hours against the rota, fix anything that's off, choose how the clock affects pay, then approve — and it flows straight into the pay run.",
  doneLine: "So: your staff clock in, you watch it live here, tidy the hours, set how the clock affects pay in Settings, approve — and Payroll reads it. No re-keying.",
  steps: [
    { label: "The live count & listing filter", stage: "Overview", line: "Four tiles across the top count everyone right now — clocked in, on a break, clocked out, and off on leave. The 'Filter by listing' dropdown re-scopes the whole page to one site, so on a busy multi-venue day you jump straight into just Milton Keynes.", bodyHtml: `<div class="frm"><div class="chips"><span class="ochip">🟢 Clocked in · 2</span><span class="ochip">⏸ On break · 1</span><span class="ochip">Clocked out · 2</span><span class="ochip">🏖 Off · 1</span></div><div class="fl">FILTER BY LISTING</div><div class="field">All listings ▾</div><div class="hint">Pick a site and the Who's-in board and Timesheets both narrow to it together.</div></div>` },
    { label: "Who's in — the live board", stage: "Who's in", line: "The first tab is a live board of cards, grouped into Clocked in, On break, Off today and Clocked out. Each card shows the person's name, role and listing, and a pink strip with their clock-in time, whether they were late, and where. If someone forgets to clock out, click 'Clock out' on their card and you do it for them.", bodyHtml: `<div class="frm"><div class="fl">🟢 CLOCKED IN · 2</div><div class="tkt"><div class="tkhd"><b>Aisha Rahman</b> <span class="g">Lead · Milton Keynes</span><span class="chip2">Clock out</span></div><div class="hint">15:15 — Clocked in · Milton Keynes</div></div><div class="tkt"><div class="tkhd"><b>Dan Reed</b> <span class="g">Lead · Bedford</span><span class="chip2">Clock out</span></div><div class="hint">15:45 — Clocked in · 12m late · Bedford</div></div><div class="fl">⏸ ON BREAK · 1</div><div class="tkt"><div class="tkhd"><b>Tom Lewis</b> <span class="g">Coach · Milton Keynes</span></div><div class="hint">On break since 17:25</div></div></div>` },
    { label: "Today's timesheet", stage: "Timesheets", line: "Open the Timesheets tab for today's hours. Each row shows their clock in and out, break, hours worked, their scheduled hours, any lateness, and overtime — that's anything worked beyond the rota. Overtime with a star is above scheduled and stays unpaid until you approve it. The last column, Pay hrs, is what actually goes to payroll.", bodyHtml: `<div class="frm"><div class="row2"><div class="fl">EMPLOYEE</div><div class="fl">IN · OUT · WORKED · SCHED · OT · PAY</div></div><div class="tkt"><div class="tkhd"><b>Aisha Rahman</b> <span class="g">15:15 · in… · 2.52h · 3.00h</span><span class="tkp">2.52h</span></div></div><div class="tkt"><div class="tkhd"><b>Dan Reed</b> <span class="g">worked 8.40h · sched 8.00h · +0.40h *</span><span class="tkp">8.00h</span></div></div><div class="hint">The <b>*</b> = overtime above scheduled, unpaid until you approve it. Click <b>Approve</b> to release a row to the pay run.</div></div>` },
    { label: "Fix a row — times, break & pay basis", stage: "Edit", line: "Click the pencil on any row to fix it. Change the clock-in or clock-out time, adjust the break, or choose how the shift is paid — actual worked hours, their scheduled 'normal' hours, scheduled less any lateness, or a set number — and add a reason. This is your override when someone forgot to clock, or you agreed a fixed figure.", bodyHtml: `<div class="frm"><div class="fl">EDIT TIMESHEET · DAN REED</div><div class="row2"><div><div class="fl">CLOCK IN</div><div class="field">15:45</div></div><div><div class="fl">CLOCK OUT</div><div class="field">--:--</div></div></div><div class="fl">PAY THIS SHIFT AS</div><div class="chips"><span class="ochip">Actual worked</span><span class="ochip">Scheduled (normal)</span><span class="ochip">Scheduled, less lateness</span><span class="ochip">A set number</span></div><div class="hint">Scheduled-less-late pays the rota hours minus late minutes — arriving early adds nothing.</div></div>` },
    { label: "Set the pay rules — Settings tab", stage: "Settings", line: "The Settings tab is the important one. The Default pay policy decides how the clock affects everyone's pay — pay actual hours, pay scheduled flat, or pay scheduled minus lateness. If you pick actual, an Auto-pay overtime toggle decides whether over-scheduled hours are paid or held for approval. You also set the grace period, hour rounding, and the name of your 'Lead' role — leads see everyone working at their own listing.", bodyHtml: `<div class="frm"><div class="fl">DEFAULT PAY POLICY (EVERYONE)</div><div class="field">Scheduled hours, less any lateness ▾</div><div class="tkt"><div class="tkhd"><b>Auto-pay overtime</b> <span class="g">actual policy only</span><span class="chip2">off</span></div></div><div class="row2"><div><div class="fl">GRACE</div><div class="field">5 min</div></div><div><div class="fl">ROUND TO</div><div class="field">Nearest 15 min</div></div></div><div class="fl">"LEAD" ROLE NAME</div><div class="field">Site manager</div><div class="hint">Rename "Lead" to whatever you call site leads — they then see their team's clock-ins.</div></div>` }
  ]
};

TOUR_CONFIGS.holiday = {
  title: "Leave & absence",
  introLine: "This is your whole absence system: staff request time off, you approve or decline with a clash check, and everyone's entitlement is worked out to UK law. It covers holiday, sickness with SSP, maternity, adoption, bereavement and more — and it feeds straight into the Schedule and Payroll.",
  doneLine: "So: requests land here, you approve with the clash check, entitlements follow the law, and approved leave shows on the Schedule and drives pay. Add leave yourself with '+ Add leave' any time.",
  steps: [
    { label: "The summary strip & tabs", stage: "Overview", line: "Four tiles show pending requests, who's off today, the leave year and your team size. Below sit four tabs — Requests, Who's off, Allowances and Settings — and the '+ Add leave' button top-right lets you enter leave for anyone yourself.", bodyHtml: `<div class="frm"><div class="chips"><span class="ochip">📋 Pending · 4</span><span class="ochip">🏖 Off today · 1</span><span class="ochip">Leave year · 2026</span></div><div class="chips"><span class="ochip">Requests</span><span class="ochip">Who's off</span><span class="ochip">Allowances</span><span class="ochip">Settings</span></div><div class="field" style="text-align:right">+ Add leave</div></div>` },
    { label: "Approving requests", stage: "Requests", line: "The Requests tab is your approval queue. Each request shows the person, type and dates, and how many days they'll have left once approved. Click 'Show conflicts' to see anyone else off at the same time. Then Approve, Edit the dates, or Decline with a reason.", bodyHtml: `<div class="frm"><div class="tkt"><div class="tkhd"><b>Jess Patel</b> <span class="g">🌴 Annual · Mon 21 – Fri 25 Aug</span></div><div class="hint">Jess will have <b>7 of 22.4 days</b> left once approved · 🚩 Show conflicts (1)</div><div class="chips"><span class="ochip">Approve</span><span class="ochip">Edit</span><span class="ochip">Decline</span></div></div><div class="tkt"><div class="tkhd"><b>Tom Lewis</b> <span class="g">🤒 Sickness · 2 days</span><span class="chip2">SSP eligible</span></div></div></div>` },
    { label: "Who's off & who needs covering", stage: "Who's off", line: "The Who's off tab is a week timeline of everyone booked off. Where a person is off but was also on the rota that day, it flags a red 'COVER' block, so you can spot exactly which shifts need reassigning in the Schedule. Step the weeks with the arrows.", bodyHtml: `<div class="frm"><div class="fl">WEEK · 11 – 17 AUG</div><div class="tkt"><div class="tkhd"><b>Priya Khan</b> <span class="g">🌴 Annual</span></div><div class="chips"><span class="ochip">Mon</span><span class="ochip">Tue</span><span class="chip2">Wed · COVER</span><span class="ochip">Thu</span></div></div><div class="hint">⚠ 1 rostered shift needs covering — open the Schedule to reassign.</div></div>` },
    { label: "Allowances & how the law is worked out", stage: "Allowances", line: "The Allowances tab lists everyone's entitlement. Statutory holiday is 5.6 weeks times the days they work a week, capped at 28 — the tool computes it. A Holiday-pay toggle switches casual staff to 'included in pay' at 12.07%, and clicking Edit lets you set a part-time pattern, carry-over, or their real start date and average earnings for a migrated worker.", bodyHtml: `<div class="frm"><div class="row2"><div class="fl">EMPLOYEE · BASIS</div><div class="fl">ALLOW · REMAINING</div></div><div class="tkt"><div class="tkhd"><b>Aisha Rahman</b> <span class="g">5 d/wk · Statutory</span><span class="tkp">28 · 25 left</span></div></div><div class="tkt"><div class="tkhd"><b>Tom Lewis</b> <span class="g">casual</span><span class="chip2">In pay 12.07%</span></div></div><div class="hint">Set everyone's holiday pay at once, or override one person on their row.</div></div>` },
    { label: "Add leave yourself & the pay treatment", stage: "Add", line: "'+ Add leave' opens a form to enter leave for anyone. Pick the employee, then the type — and right under it you see their live entitlement, so you never book blind. Each type sets a pay treatment automatically: annual is normal pay, sickness is SSP, maternity is statutory, unpaid is unpaid — all overridable to your policy.", bodyHtml: `<div class="frm"><div class="fl">ADD LEAVE</div><div class="field">Employee · Marcus Bell ▾</div><div class="field">Type · 🌴 Annual leave ▾</div><div class="hint">Marcus · <b>25 of 28</b> left → <b>20 after this</b> · Taken 3 · Booked 5</div><div class="fl">PAY FOR THIS LEAVE</div><div class="field">Paid — normal pay ▾</div></div>` },
    { label: "Settings — the leave year, allowance & sick pay", stage: "Settings", line: "The Settings tab sets your policy: when the leave year starts, whether the standard allowance is the statutory minimum or a custom figure, and whether bank holidays are on top. It's also where you set your sick-pay policy — SSP only or company sick pay — and the sickness reporting rule, like 'must tell us at least 3 hours before the shift'.", bodyHtml: `<div class="frm"><div class="row2"><div><div class="fl">LEAVE YEAR STARTS</div><div class="field">January · 1</div></div><div><div class="fl">STANDARD ALLOWANCE</div><div class="field">Statutory 5.6 wks</div></div></div><div class="fl">SICK PAY</div><div class="field">Statutory Sick Pay only ▾</div><div class="fl">SICKNESS REPORTING</div><div class="field">At least 3 hours before the shift</div></div>` }
  ]
};

TOUR_CONFIGS.payroll = {
  title: "Payroll",
  introLine: "This is your pay run. It pulls hours and rates from onboarding and the rota, estimates PAYE, National Insurance and pension, produces branded payslips, and posts a wages journal to your accounting software. Everything is a planning estimate until your payroll provider files it for real.",
  doneLine: "So: check your people, run the month, tidy any row, approve to generate payslips, and post the journal to QuickBooks, Xero or Sage — or export a CSV.",
  steps: [
    { label: "Your month at a glance", stage: "Overview", line: "The Overview tiles total this period's gross pay, the net to pay, the PAYE and NI owed to HMRC, and your all-in employer cost. It also shows the next pay day and your recent runs — a payroll record is never overwritten, so every run is kept.", bodyHtml: `<div class="frm"><div class="row2"><div class="tkt"><div class="tkhd"><b>Gross</b> <span class="g">6 employees</span><span class="tkp">£9,060</span></div></div><div class="tkt"><div class="tkhd"><b>Net to pay</b> <span class="g">after deductions</span><span class="tkp">£7,857</span></div></div></div><div class="row2"><div class="tkt"><div class="tkhd"><b>To HMRC</b> <span class="g">PAYE + NI</span><span class="tkp">£917</span></div></div><div class="tkt"><div class="tkhd"><b>Employer cost</b> <span class="g">incl. ER NI + pension</span><span class="tkp">£10,216</span></div></div></div></div>` },
    { label: "Employees", stage: "Employees", line: "The Employees tab lists your team with pay basis — hourly or salary — their rate, hours a week, tax code and pension status. Click Edit to fix any of it, set term-time weeks a year, or switch someone between being paid from contracted hours and paid from the rota.", bodyHtml: `<div class="frm"><div class="tkt"><div class="tkhd"><b>Marcus Bell</b> <span class="g">Salary · £26,000/yr · 1257L</span><span class="chip2">Enrolled</span></div></div><div class="tkt"><div class="tkhd"><b>Jess Patel</b> <span class="g">Hourly · £13.50/hr · 22 h/wk</span><span class="chip2">Edit</span></div></div></div>` },
    { label: "Run the pay run", stage: "Pay run", line: "The Pay run tab is the heart of it. Pick the frequency — weekly, fortnightly, 4-weekly or monthly — and step the period. Choose whether hourly staff are paid from contracted hours or actual rostered hours from the Schedule. Every row is editable: click the pencil to add overtime or a bonus, a deduction, or override the tax. Then approve to generate payslips.", bodyHtml: `<div class="frm"><div class="chips"><span class="ochip">Weekly</span><span class="ochip">Monthly</span></div><div class="fl">HOURLY PAY FROM</div><div class="chips"><span class="ochip">Contracted hours</span><span class="ochip">Rostered (Schedule)</span></div><div class="tkt"><div class="tkhd"><b>Jess Patel</b> <span class="g">82.5h · gross £1,113</span><span class="tkp">net £1,065</span></div></div><div class="field" style="text-align:right">✓ Approve &amp; generate payslips</div></div>` },
    { label: "Payslips", stage: "Payslips", line: "Once approved, the Payslips tab lists every run. Click a person to open a branded, printable payslip — tax code, tax period, National Insurance, pension, year-to-date and employer costs, with an hours line for hourly staff. Your team also see their own under 'My payslips'.", bodyHtml: `<div class="frm"><div class="fl">AUGUST 2026 · PAYSLIPS</div><div class="tkt"><div class="tkhd"><b>Jess Patel</b> <span class="g">Coach</span><span class="tkp">🧾 £1,065 net</span></div></div><div class="tkt"><div class="tkhd"><b>Marcus Bell</b> <span class="g">Lead</span><span class="tkp">🧾 £1,770 net</span></div></div><div class="hint">Marked "estimated" until your payroll provider files it for real.</div></div>` },
    { label: "Integrations & export", stage: "Integrations", line: "The Integrations tab connects QuickBooks, Xero or Sage — then each approved run posts as a wages journal, no re-keying. There's always a CSV export as a fallback for any provider. Connecting for real, and the RTI filing to HMRC, are the backend piece.", bodyHtml: `<div class="frm"><div class="row2"><div class="tkt"><div class="tkhd"><b>🟢 QuickBooks</b> <span class="g">post the wages journal</span><span class="chip2">Connect</span></div></div><div class="tkt"><div class="tkhd"><b>🔵 Xero</b> <span class="g">sync PAYE/NI/pension</span><span class="chip2">Connect</span></div></div></div><div class="hint">Or export a CSV for any provider.</div></div>` }
  ]
};
