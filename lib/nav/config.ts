  ...
  company: [
    ...
    },
    {
      ...
      items: [
        ...
        { view: "templates", legacyView: "templates", label: "Message templates", hidden: true, icon: null, badge: null },
  ...
  franchise: [
    ...
    },
    {
      ...
      items: [
        ...
        { view: "templates", legacyView: "franchise-templates", label: "Message templates", hidden: true, icon: null, badge: null },
  ...
  freelancer: [
    ...
    },
    {
      ...
      items: [
        ...
        { view: "templates", legacyView: "freelancer-templates", label: "Message templates", hidden: true, icon: null, badge: null },
