...
export const NAV_GROUPS: Record<PortalKey, NavGroup[]> = {
  company: [
    ...
    },
    {
      ...
      items: [
        ...
        { view: "purchasing", legacyView: "admin-purchasing", label: "Bills & POs", icon: { type: "svg", markup: "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.7\" stroke-linecap=\"round\" stroke-linejoin=\"round\" style=\"width:1em;height:1em;vertical-align:-.14em;display:inline-block;flex:none\"><path d=\"M4.5 6.5h15l-1.2 8.5a2 2 0 0 1-2 1.7H7.7a2 2 0 0 1-2-1.7z\"></path><path d=\"M4.5 6.5 3.4 3.4H1.8M9 20.2h.01M15.5 20.2h.01\"></path></svg>" }, badge: null },
        { view: "invoices", legacyView: "admin-invoices", label: "Invoices", icon: { type: "glyph", value: "📨" }, badge: null },
    ...
    },
    {
      ...
      items: [
        ...
        { view: "templates", legacyView: "templates", label: "Templates", icon: { type: "glyph", value: "📝" }, badge: null },
  ...
  franchise: [
    ...
    },
    {
      ...
      items: [
        ...
        { view: "purchasing", legacyView: "franchise-purchasing", label: "Bills & POs", icon: { type: "svg", markup: "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.7\" stroke-linecap=\"round\" stroke-linejoin=\"round\" style=\"width:1em;height:1em;vertical-align:-.14em;display:inline-block;flex:none\"><path d=\"M4.5 6.5h15l-1.2 8.5a2 2 0 0 1-2 1.7H7.7a2 2 0 0 1-2-1.7z\"></path><path d=\"M4.5 6.5 3.4 3.4H1.8M9 20.2h.01M15.5 20.2h.01\"></path></svg>" }, badge: null },
        { view: "invoices", legacyView: "franchise-invoices", label: "Invoices", icon: { type: "glyph", value: "📨" }, badge: null },
    ...
    },
    {
      ...
      items: [
        ...
        { view: "templates", legacyView: "franchise-templates", label: "Templates", icon: { type: "glyph", value: "📝" }, badge: null },
  ...
  freelancer: [
    ...
    },
    {
      ...
      items: [
        ...
        { view: "purchasing", legacyView: "freelancer-purchasing", label: "Bills & POs", icon: { type: "svg", markup: "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.7\" stroke-linecap=\"round\" stroke-linejoin=\"round\" style=\"width:1em;height:1em;vertical-align:-.14em;display:inline-block;flex:none\"><path d=\"M4.5 6.5h15l-1.2 8.5a2 2 0 0 1-2 1.7H7.7a2 2 0 0 1-2-1.7z\"></path><path d=\"M4.5 6.5 3.4 3.4H1.8M9 20.2h.01M15.5 20.2h.01\"></path></svg>" }, badge: null },
        { view: "invoices", legacyView: "freelancer-invoices", label: "Invoices", icon: { type: "glyph", value: "📨" }, badge: null },
    ...
    },
    {
      ...
      items: [
        ...
        { view: "templates", legacyView: "freelancer-templates", label: "Templates", icon: { type: "glyph", value: "📝" }, badge: null },
  ...
  custdash: [
    ...
    },
    {
      ...
      footer: false,
      items: [
        { view: "messages", legacyView: "custdash-messages", label: "Messages", hidden: true, icon: { type: "svg", markup: "<svg viewBox=\"0 0 24 24\" width=\"16\" height=\"16\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect x=\"3\" y=\"5\" width=\"18\" height=\"14\" rx=\"2\"></rect><path d=\"M3 7l9 6 9-6\"></path></svg>" }, badge: "1" },
