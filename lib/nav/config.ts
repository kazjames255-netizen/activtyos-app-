...
export interface NavItem {
  ...
  icon: NavIcon | null;
  badge: string | null;
  /** Routable but not shown in the sidebar — e.g. promoted into the top tab
   *  bar. The route still validates against nav membership, so it stays here. */
  hidden?: boolean;
  /** Temporary review flag: this item exists in THIS portal but not in the
   *  freelancer sidebar. The Sidebar tints it yellow so it's easy to spot. */
  highlight?: boolean;
}
  ...
  company: [
    {
      ...
      items: [
        ...
        { view: "learninghub", legacyView: "admin-learninghub", label: "Teaching Hub", icon: { type: "glyph", value: "📚" }, badge: null },
      ],
    },
    {
      label: "Communication",
    ...
    },
    {
      ...
      footer: false,
      items: [
        { view: "finance", legacyView: "finance", label: "Finance & analytics", icon: { type: "glyph", value: "£" }, badge: null },
    ...
    },
    {
      ...
      items: [
        ...
        { view: "timesheets", legacyView: "admin-timesheets", label: "Clock in/out & timesheets", highlight: true, icon: { type: "glyph", value: "⏱" }, badge: null },
        ...
        { view: "credentials", legacyView: "credentials", label: "Compliance & certs", highlight: true, icon: { type: "glyph", value: "🎖" }, badge: null },
  ...
  franchise: [
    {
      ...
      items: [
        ...
        { view: "learninghub", legacyView: "franchise-learninghub", label: "Teaching Hub", icon: { type: "glyph", value: "📚" }, badge: null },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { view: "calendar", legacyView: "cal-franchise", label: "Events calendar", icon: { type: "svg", markup: "<svg viewBox=\"0 0 24 24\" width=\"13\" height=\"13\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect x=\"3\" y=\"4.5\" width=\"18\" height=\"16\" rx=\"2\"></rect><path d=\"M3 9.5h18M8 3v3M16 3v3\"></path></svg>" }, badge: null },
        ...
        { view: "tasks", legacyView: "franchise-tasks", label: "Task manager", icon: { type: "svg", markup: "<svg viewBox=\"0 0 24 24\" width=\"14\" height=\"14\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M9 11l3 3 9-9\"></path><path d=\"M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h10\"></path></svg>" }, badge: null },
      ],
    },
    {
      label: "Your team",
    ...
    },
    {
      ...
      items: [
        ...
        { view: "milestones", legacyView: "franchise-milestones", label: "Milestones", hidden: true, icon: { type: "glyph", value: "🎯" }, badge: null },
  ...
  freelancer: [
    {
      ...
      items: [
        ...
        { view: "learninghub", legacyView: "freelancer-learninghub", label: "Teaching Hub", icon: { type: "glyph", value: "📚" }, badge: null },
      ],
    },
    {
      label: "Communication",
  ...
  staff: [
    ...
    },
    {
      ...
      items: [
        ...
        { view: "learninghub", legacyView: "staff-learninghub", label: "Teaching Hub", icon: { type: "glyph", value: "📚" }, badge: null },
      ],
    },
    {
      label: "Pay & personal",
  ...
  custdash: [
    {
      ...
      items: [
        ...
        { view: "learninghub", legacyView: "custdash-learninghub", label: "My Classroom", icon: { type: "glyph", value: "📚" }, badge: null },
        { view: "moments", legacyView: "custdash-moments", label: "Moments", icon: { type: "glyph", value: "📷" }, badge: null },
    ...
    {
      label: "First aid, medication & incidents",
      pinned: false,
      footer: false,
      items: [
    ...
    },
    {
      ...
      footer: false,
      items: [
        // Payments now live on the combined "My activities & payments" page
        // (custdash/schedule). The standalone /payments route still resolves for
        // deep links (e.g. post-checkout), it's just not a separate nav item.
        // Memberships lives in the top bar as a fancy tab (see Header), not the
        // sidebar — hidden here so the route + label still resolve.
        { view: "memberships", legacyView: "custdash-memberships", label: "Memberships", hidden: true, icon: { type: "svg", markup: "<svg viewBox=\"0 0 24 24\" width=\"16\" height=\"16\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M12 3l2.6 5.3 5.9.9-4.3 4.1 1 5.8L12 16.9 6.8 19.2l1-5.8L3.5 9.2l5.9-.9z\"></path></svg>" }, badge: null },
    ...
    },
    {
      ...
      items: [
        ...
        { view: "feedback", legacyView: "custdash-feedback", label: "Leave feedback", icon: { type: "glyph", value: "⭐" }, badge: null },
        ...
        { view: "privacy", legacyView: "custdash-privacy", label: "Data & privacy", hidden: true, icon: { type: "glyph", value: "🛡" }, badge: null },
