...
export const NAV_GROUPS: Record<PortalKey, NavGroup[]> = {
  company: [
    ...
    },
    {
      ...
      footer: false,
      items: [
        { view: "finance", legacyView: "finance", label: "Finances", icon: { type: "glyph", value: "£" }, badge: null },
    ...
    },
    {
      ...
      items: [
        ...
        { view: "messages", legacyView: "messages", label: "Messages", icon: { type: "glyph", value: "▧" }, badge: null },
  ...
  custdash: [
    {
      ...
      items: [
        ...
        { view: "timetable", legacyView: "custdash-timetable", label: "Timetable", icon: { type: "svg", markup: "<svg viewBox=\"0 0 24 24\" width=\"16\" height=\"16\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect x=\"3\" y=\"3\" width=\"18\" height=\"18\" rx=\"2\"></rect><path d=\"M3 9h18M9 3v18\"></path></svg>" }, badge: null },
      ],
    },
    {
